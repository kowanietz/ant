...
function AntWordmark() {
  return (
    ...
    >
      <circle cx="64" cy="89" r="39" fill="currentColor" />
      <circle cx="64" cy="27" r="27" fill="currentColor" />
    </svg>
  );
}
  ...
  const wordmark = (
    <div className="flex items-center gap-2">
      ...
      <Tooltip>
        <TooltipTrigger
          render={
            <div className="flex min-w-0 flex-1 items-center gap-2 ml-1 cursor-pointer">
              <AntWordmark />
